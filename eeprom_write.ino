...
void setup()
{
  ...
  {
    Serial.print(byte(EEPROM.read(i))); Serial.print("ttttt ");
  }
  Serial.println();
...
void loop()
{
  ...
  Serial.print(val); Serial.print("kkkkk ");
  ...
  if (addr == EEPROM_SIZE)
  {
    Serial.println();
    addr = 0;
    Serial.print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx ");Serial.println((EEPROM.commit()));
