...
/*
Sonuç olarak, .get ve .put işlevleri, her bir EEPROMClass nesnesi için ayrı bir bellek bölgesini temsil etmek üzere 0'dan başlayan farklı başlangıç adreslerini kullanır. 
Bu sayede her bir EEPROMClass nesnesi, kendi verilerini ayrı bir bellek bölgesinde saklar ve bu verilere erişim ve güncelleme işlemleri kolaylıkla yapılabilir.
*/
